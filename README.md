...
The checked-in samples under `public/samples/` are self-contained public-safe fixtures generated for this repository. They cover shape animation, gradient fill, merge paths, text layers, precomposition, embedded image assets, and trim paths.
